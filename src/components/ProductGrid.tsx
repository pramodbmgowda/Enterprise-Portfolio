...
export default function ProductGrid() {
  ...
  return (
    <section id="products" className="relative bg-[#021c16] py-24 border-t border-[#C5A059]/10">
      <div className="container mx-auto px-4">
        
        {/* HEADER: PERFECTLY CENTERED (Phone & Laptop) */}
